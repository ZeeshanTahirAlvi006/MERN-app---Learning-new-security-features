...
// DOMPurify and JSDOM setup
import { JSDOM } from "jsdom";
import createDOMPurify from "dompurify";
const window = new JSDOM("").window;
const dompurify = createDOMPurify(window);

import rateLimit from "express-rate-limit" //limits the number of requests from single API
...
//Routes
app.use("/users", strictRateLimiter, userRouter)//User Routes
